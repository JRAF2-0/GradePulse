...
-- Current user is the teacher of this class
...
-- Current user is an enrolled student of this class
...
-- Current user is the teacher of the class that owns this grade_category
...
-- Current user is the teacher of the class that owns this grade_item
...
-- Current student can read this grade_item (enrolled + item is published)
...
-- Current user is the teacher of the class that owns this score's grade_item
...
-- -----------------------------------------------------------------------------
-- REWRITE POLICIES TO USE HELPERS (no more cross-table exists in RLS)
-- -----------------------------------------------------------------------------
